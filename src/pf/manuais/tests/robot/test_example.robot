...
#
#  $ bin/test -s pf.manuais -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src pf.manuais.testing.PF_MANUAIS_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/pf/manuais/tests/robot/test_example.robot
#
